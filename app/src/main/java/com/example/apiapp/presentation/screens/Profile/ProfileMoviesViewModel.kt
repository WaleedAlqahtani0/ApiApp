...
import com.example.apiapp.domain.user.GetSessionIdUseCase
import com.example.apiapp.domain.user.GetUserAccountUseCase
import com.example.apiapp.domain.user.GetUserTokenUseCase
...
@HiltViewModel
class ProfileMoviesViewModel @Inject constructor(
